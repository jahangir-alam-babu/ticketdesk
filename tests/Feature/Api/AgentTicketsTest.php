...
class AgentTicketsTest extends TestCase
{
    ...
    {
        factory(User::class)->create(['email' => 'admin@demo.com', 'password' => bcrypt('12345678'), 'token' => 'agent-token', 'admin' => true]);

        $response = $this->post("api/agent/login", ["email" => 'admin@demo.com', 'password' => '12345678']);
